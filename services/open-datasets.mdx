...
<CardGroup cols={2}>
  ...
  <Card title="Tutorials" icon="graduation-cap">
    ...
    [Start Learning](/tutorials/open-datasets)
  </Card>
...
- [Quickstart: Use Open Datasets in Azure ML](/quickstart)
- [Tutorial: Build a forecasting model with weather data](/tutorials/weather-forecast)
- [How to: Enrich your data with Open Datasets](/how-to/enrich-data)
- [Reference: Complete dataset list](/reference/datasets)